...
class TestPandaEnv(Env):
    ...
    def __init__(self,
        ...
        self.ctrl_type = "EEImpedance"

        if not self.world.is_sim:
    ...
    def get_observation(self):
        ...
        """
        obs = {"q": self.robot_interface.q, "ee_pose": self.robot_interface.ee_pose}
        return obs
    ...
    def _exec_action(self, action):
        ...
        #self.robot_interface.move_ee_delta(action, set_pos=None, set_ori=None)
